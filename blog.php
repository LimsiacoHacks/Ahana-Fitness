			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Yoga for Slim Physique</a></h2>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">The Perfect Dose</a></h2>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Flexible Body</a></h2>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">The Secret to Improving</a></h2>
							<p>Regular practice with breathing tech-niques in Yoga will help you get a toned body, this is the perfect choice</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Movements for Slim</a></h2>
							<p>To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Update Training Trend</a></h2>
							<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Have a Toned Body</a></h2>
							<p>Regular practice with breathing tech-niques in Yoga will help you get a toned body, this is the perfect choice</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Rapid Weight Loss</a></h2>
							<p>To take a trivial example, which of us ever undertakes laborious physical exercise, except to obtain</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog-item">
						...
						<div class="bi-text">
							<h2><a href="single-blog.php">Healthy Eating Mode</a></h2>
							<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis prae-sentium voluptatum deleniti</p>
						</div>
						<div class="bi-footer">
							<div class="bi-cata">Health & Beauty</div>
